...
all:	rstest randFile rsencode rsdecode dedup dbsetup cryptoalgo decrypt
...
clean:
	rm  rsencode.o rsdecode.o randFile.o  upload.o rstest.o  sqlsimdtct.o cryptoalgo.o dedup.o decrypt.o
